...
public class LocationUtils {
	 ...
	 * @throws Exception Throws whenever an invalid string is given
	 */
	public static Location parseLocation(@Nullable World w, String locationString) throws Exception {
		...
		try {
			...
			throw new Exception("Unable to split positions from location string: " + locationString, e);
		}
		...
		try {
			...
			throw new Exception("Unable to parse number from location string: " + locationString, e);
		}
	}
